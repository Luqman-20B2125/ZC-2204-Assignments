...
class CustomerSupport:
    ...
    def process_tickets(self, processing_strategy_function: Callable[[List[SupportTicket]],List[SupportTicket]]):
        ticket_list = processing_strategy_function(self.tickets)
...
app.create_ticket("Muhammad Luqman","My computer has low battery life")
app.create_ticket("Ahmad","No audio playing at all")
app.create_ticket("Ali","My gamepad controller is not working when I try to play games with it")
